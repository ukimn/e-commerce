		...
		<>
			<div className="flex items-center flex-col mt-5">
				<div className="flex flex-col justify-around items-center border py-14 px-10 rounded-sm gap-4">
					<h1 className="text-2xl font-medium">NOTE: All These Info comes from GitHub</h1>
					<div>
						<Image src={session?.user.image} alt="User Image" width={150} height={150} className="rounded-full"/>
					</div>
